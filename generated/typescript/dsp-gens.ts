...
export const dspGens = {
  ...
  freesound: { inherits: 'sample', props: [ 'id' ], hasAudioOut: true },
  ...
  noise: { inherits: 'osc', props: [], hasAudioOut: true },
  ...
  say: { inherits: 'sample', props: [ 'text' ], hasAudioOut: true },
...
export namespace Props {
  ...
  export interface Freesound extends Sample {
    id?: string
  }
  ...
  export interface Noise extends Osc {
  ...
  export interface Sample extends Gen {
    offset?: Value | number
    length?: Value | number
    trig?: Value | number
  }
  ...
  export interface Say extends Sample {
    text?: string
  }
