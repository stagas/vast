...
export const Offsets: usize[][] = [
  ...
  [offsetof<Gen>('gain'),offsetof<Osc>('hz'),offsetof<Osc>('trig'),offsetof<Osc>('offset')],
  [offsetof<Gen>('gain'),offsetof<Sample>('offset'),offsetof<Sample>('length'),offsetof<Sample>('trig'),offsetof<Freesound>('id')],
  [offsetof<Gen>('gain')],
  ...
  [offsetof<Gen>('gain'),offsetof<Sample>('offset'),offsetof<Sample>('length'),offsetof<Sample>('trig')],
  [offsetof<Gen>('gain'),offsetof<Svf>('in'),offsetof<Sap>('cut'),offsetof<Sap>('q')],
  [offsetof<Gen>('gain'),offsetof<Osc>('hz'),offsetof<Osc>('trig'),offsetof<Osc>('offset')],
  [offsetof<Gen>('gain'),offsetof<Sample>('offset'),offsetof<Sample>('length'),offsetof<Sample>('trig'),offsetof<Say>('text')],
