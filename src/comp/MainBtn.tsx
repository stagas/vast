...
export function Btn({ icon, onclick, onpointerdown, children }: { icon?: JSX.Element | string | null, onclick?: () => void, onpointerdown?: () => void, children?: any[] }) {
  return <button class="btn relative flex flex-col items-center justify-items-center p-4 mt-[-1px] top-[1px] pt-0 pb-[2px]" onclick={onclick} onpointerdown={onpointerdown}>
